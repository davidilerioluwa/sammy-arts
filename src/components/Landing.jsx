  ...
  return (
    ...
    className='flex gap-8 text-white items-center p-8 pt-16 lg:p-20' >
        ...
        <div className='flex flex-col text-left w-fit lg:max-w-lg gap-4'>
            ...
            <div className='text-sm hidden md:block'><ReactTyped strings={["Lorem ipsum dolor sit, amet consectetur adipisicing elit. Qui, modi. Quas illo illum obcaecati incidunt totam soluta deserunt, enim itaque vero magni similique recusandae sequi consequatur corporis expedita maiores cumque."]} /></div>
            <button className='text-white bg-red px-6 py-4 w-fit rounded-md' onClick={()=>setPopup(true)}>ABOUT ME</button>
        </div>
    </motion.div>
  )
}
